<div class="container">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
				...
				<?php echo form_input('cadastro[nome]', $query->nome, 'id="nome" maxlength="255" class="validar form-control" validar="digite o nome da atividade"')?>
	...
	<div class="form-group">	
		...
		<div class="col-sm-8">
				...
				<?php echo form_input('cadastro[descricao]', $query->descricao, 'id="descricao"  class="form-control" validar="digite a descricao" ')?>
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			...
			<?php echo form_input('cadastro[data_inicio]', $query->data_inicio, 'id="date" class="form-control" maxlength="10" readonly="readonly"');?>
		</div>
		<label for="data_fim" class="col-sm-2 control-label">Data Final</label>
		<div class="col-sm-2">
			<?php echo form_input('cadastro[data_fim]', $query->data_fim, 'id="date2" class="form-control" maxlength="10" readonly="readonly"');?>
		</div>
	</div>
	...
	<div class="form-group">
		<label for="status" class="col-sm-2 control-label">Status</label>
			<div class="col-sm-2">
				<?php echo form_dropdown('cadastro[status]', $status, $query->status, 'id="status" class="form-control"')?>
			</div>
		<label for="situacao" class="col-sm-2 control-label"><?php echo utf8_encode('Situação'); ?></label>
			<div class="col-sm-2">	
				<?php echo form_dropdown('cadastro[situacao]', $situacao, $query->situacao,'id="situacao" class="form-control"')?>
			</div>
	</div>		
	<hr />
