				...
				if($linhas==2){
					switch($this->colunaSelecionada){
						...
						case('v'):
							...
							break;
						case('n_p_v_c'):
							$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Chuva(mm)</b></td><td><b>Nivel(m)</b></td><td><b>Vaz&atilde;o(m3)</b></td><td><b>Cota</b></td></tr>';
							break;
			...
			if($linhas < 3){
				if($linhas==2){
					switch($this->colunaSelecionada){
						...
						case('n_p_v_c'):
							$tabela =  "Data/Hora    Chuva(mm)      Nivel(m)    Vazão(m3)     Cota\r\n";
							fwrite($arquivoExportacao, $tabela);
							break;
