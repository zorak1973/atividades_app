...
class Leituradados{
				...
				if($linhas==2){
					switch($this->strEfetivos){
						...
						case('p_c'):
							...
							break;
						case('p_n_c'):
							$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Chuva(mm)</b></td><td><b>Cota(m)</b></td><td><b>Nivel(m)</b></td></tr>';
							break;
						case('n_v_c'):
							$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Nivel(m)</b></td><td><b>Cota(m)</b></td><td>Vazão(m3/s)</td></tr>';
							break;
						case('v'):
							$tabela .=  '<tr><td><b>Data/Hora</b></td><td>Vazão(m3/s)</td></tr>';
							break;
						case('p_v'):
							$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Chuva(mm)</b></td><td>Vazão(m3/s)</td></tr>';
							break;	
						case('p_n_v_c'):
							$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Chuva(mm)</b></td><td><b>Nivel(m)</b></td><td><b>Cota(m)</b></td><td>Vazão(m3/s)</td></tr>';
							break;
						case(''):
	...
	/*case('n'):
						...
						case('v_p'):
							...
							break;	
						case('n_p_v_c'):
							$tabela =  "Data/Hora \t   Chuva(mm)    Nivel(m)   Cota(m)  Vazão(m3/s)\r\n";
							fwrite($arquivoExportacao, $tabela);
							break;
					*/	
