...
class Leituradados{
	...
	public function lerArquivoExcelHtml(){
		...
		switch($this->strEfetivos){
			...
			case('c'):
				...
				break;
			case('p'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atildeo(mm)</b></td></tr>';
				break;
			case('p_n'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atildeo(mm)</b></td><td><b>N&iacute;vel(m)</b></td></tr>';
				break;
			case('p_c'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atildeo(mm)</b></td><td><b>Cota(m)</b></td></tr>';
				break;
			case('p_n_c'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atildeo(mm)</b></td><td><b>Cota(m)</b></td><td><b>N&iacute;vel(m)</b></td></tr>';
				break;
			case('n_v_c'):
			...
			case('v'):
				...
				break;
			case('p_v'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atildeo(mm)</b></td><td><b>Vaz&atilde;o(m3/s)</b></td></tr>';
				break;	
			case('p_n_v_c'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atildeo(mm)</b></td><td><b>N&iacute;vel(m)</b></td><td><b>Cota(m)</b></td><td><b>Vaz&atilde;o(m3/s)</b></td></tr>';
				break;
			case(''):
				$tabela .=  "<tr><td>A esta&ccedil;&atildeo n&atilde;o possui os dados solicitados.</td></tr>";
				break;
		...
		//Lï¿½ O ARQUIVO ATï¿½ CHEGAR AO FIM 
		while (!feof($this->ponteiro)) {
		  
		//Lï¿½ UMA LINHA DO ARQUIVO
	...
	public function lerArquivoExcelHtmlChuvaAcumulada(){
		...
		//LÊ UMA LINHA DO ARQUIVO
			...
			if($this->garrison === '300234063416560'){
				$tabela .="<tr><td>Esta&ccedil;&atildeo n&atilde;o possui dados pluviom&eacute;tricos</td></tr>";
				$tabela .="</table>";
				return $tabela;
			...
			if($linhas >= 3){
				...
				if($this->minutoEnvio == "00"){
					...
					if($this->minutoEnvio == "05"){
						...
						if($this->minutoEnvio == "10"){
							if($this->garrison == '300234062065740'){
								$minutoSeguinte = "10";
								$minutoFinal = "23:10";
							}else{
								$minutoSeguinte = "25";
	...
	public function lerArquivoChuvaAcumulada(){
		...
		//Lï¿½ UMA LINHA DO ARQUIVO
			...
			if($this->garrison === '300234063416560'){
				$erro = "Esta&ccedil;&atildeo não possui dados pluviométricos";
				...
				if($linhas==2){
					switch($this->estacao){
						...
						case 'tocantinia':
							...
							break;
						case 'jusante':
							$colunas = "data/hora	----   	nivel(m)   -----    vazão(m3/s)\r\n";	
							break;
						case 'jacinto':
							$colunas = "data/hora 	----   	Precipitação(mm) 	nivel(m)     ------	vazão(m3/s)\r\n";
							break;
						case 'barramento':
							$colunas = "data/hora	Precipitação(mm)     -------       nivel(m)\r\n";
							break;
