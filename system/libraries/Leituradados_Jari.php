...
class Leituradados_Jari{
	...
	public function lerArquivoExcelHtml(){
		...
		if(substr($this->estacao, 0, 4) != "jari"){
				$fileName = "jari-".$this->estacao.".txt";
		}else{
			$fileName = $this->estacao.".txt";
		}
		...
		switch($this->strEfetivos){
			...
			case('c'):
				...
				break;
			case('p'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atilde;o(mm)</b></td></tr>';
				break;
			case('p_n'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atilde;o(mm)</b></td><td><b>N&iacute;vel(m)</b></td></tr>';
				break;
			case('p_c'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atilde;o(mm)</b></td><td><b>Cota(m)</b></td></tr>';
				break;
			case('n_c'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>N&iacute;vel(m)</b></td><td><b>Cota(m)</b></td></tr>';
				break;
			case('p_n_c'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atilde;o(mm)</b></td><td><b>Cota(m)</b></td><td><b>N&iacute;vel(m)</b></td></tr>';
				break;
			case('n_v_c'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>N&iacute;vel(m)</b></td><td><b>Cota(m)</b></td><td><b>Vaz&atilde;o(m3/s)</b></td></tr>';
				break;
			case('v'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Vaz&atilde;o(m3/s)</b></td></tr>';
				break;
			case('p_v'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atilde;o(mm)</b></td><td><b>Vaz&atilde;o(m3/s)</b></td></tr>';
				break;	
			case('p_n_v_c'):
				$tabela .=  '<tr><td><b>Data/Hora</b></td><td><b>Precipita&ccedil;&atilde;o(mm)</b></td><td><b>N&iacute;vel(m)</b></td><td><b>Cota(m)</b></td><td><b>Vaz&atilde;o(m3/s)</b></td></tr>';
				break;
			case(''):
					...
					switch($this->strEfetivos){
						...
						case('c'):
							if(isset($valores2[$this->colCota])){
								if($this->colCota == $this->colNivel){
									$tabela .= "<td>".(trim($valores2[$this->colCota]) + $this->zeroRegua)."</td>";
								}else{
	...
	public function lerArquivoTxt(){
		...
		switch($this->strEfetivos){
			...
			case('c'):
				...
				break;
			case('p'):
				$tabela =  "Data/Hora    Precipitação(mm)\r\n";
				fwrite($arquivoExportacao, $tabela);
				break;
			case('p_n'):
				$tabela =  "Data/Hora    Precipitação(mm)      Nivel(m)\r\n";
				fwrite($arquivoExportacao, $tabela);
				break;
			case('p_c'):
				$tabela =  "Data/Hora    Precipitação(mm)      Cota(m)\r\n";
				fwrite($arquivoExportacao, $tabela);
				break;
			case('n_c'):
				$tabela =  "Data/Hora    Nivel(m)      Cota(m)\r\n";
				fwrite($arquivoExportacao, $tabela);
				break;
			case('p_n_c'):
				$tabela =  "Data/Hora    Precipitação(mm)      Cota(m)      Nivel(m)\r\n";
				fwrite($arquivoExportacao, $tabela);
				break;
			case('n_v_c'):
			...
			case('v'):
				...
				break;
			case('p_v'):
				$tabela =  "Data/Hora    Precipitação(mm)      Vazão(m3/s)\r\n";
				fwrite($arquivoExportacao, $tabela);
				break;	
			case('p_n_v_c'):
				$tabela =  "Data/Hora \t";
				$tabela.= "Precipitação(mm)\t";
				$tabela.= "Nivel(m) ";
				$tabela.= "Cota(m) ";
				$tabela.= "Vazão(m3/s)";
				$tabela.= "\r\n";
					...
					switch($this->strEfetivos){
						...
						case('c'):
							if(isset($teste2[$this->colCota])){
								if($this->colCota == $this->colNivel){
									$tabela = " ".$dia2."    ".(trim($teste2[$this->colCota]) + $this->zeroRegua)."\r\n";
								}else{
						...
						case('p_c'):
							...
							if(isset($teste2[$this->colCota])){
								if($this->colCota == $this->colNivel){
									$tabela .= "    ".(trim($teste2[$this->colCota]) + $this->zeroRegua)."\r\n";
								}else{
	...
	public function lerArquivoExcelHtmlChuvaAcumulada(){
		...
		//LÊ UMA LINHA DO ARQUIVO
			...
			if($this->garrison === '300234061745250'){
			...
			if($linhas < 3){
				if($linhas==2){
					switch($this->estacao){
						case 'lucena':
						case 'tocantinia':
							$colunas = "data/hora	----  precipitação(mm)     nivel(m)\r\n";
							break;
						case 'jusante':
							$colunas = "data/hora	----   	nivel(m)   -----    vazao(m3/s)\r\n";	
							break;
						case 'jacinto':
							$colunas = "data/hora 	----   	precipitação(mm) 	nivel(m)     ------	vazao(m3/s)\r\n";
							break;
						case 'jari-barramento':
							$colunas = "data/hora	nivel(m)     -------      cota(m)\r\n";
							break;
						case 'ipueiras':
						case 'areias':
							$colunas = "data/hora 	precipitação(mm)   -------  	nivel(m)    -----     -----\r\n";
							break;
						case 'jari-cachoeira':
							$colunas = "data/hora 	precipitação(mm)   -------  	nivel(m)     -----	vazao(m3/s)  ----- cota(m)\r\n";
							break;
						case 'jurupary':
							$colunas = "data/hora 	--------	precipitação(mm)     nivel(m)	-----	vazao(m3/s)\r\n";
							break;
	...
	public function obterMinuto($garrison){
		...
		switch($garrison){
			case('300234010788930'):  
			case('300234061743290'): 
			case('300234061130210'): 
			case('300234061644830'):
				$minuto = "00";
				break;
			
			
			case('300234061745250'):  
			case('300234011848430'): 	
				$minuto = "05";
				break;
			case('300234061748290'): //CHAFARIZ
	...
	public function DownloadXL($conteudo){
		if(substr($this->estacao, 0, 4) != "jari"){
			$arquivo = "jari-".$this->estacao.".xls";
		}else{
			$arquivo = $this->estacao.".xls";
		}
		//$arquivo = "jari-".$this->estacao.'.xls';
